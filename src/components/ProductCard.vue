<template>
  <div class="mb-6 lg:mb-0 w-1/5">
        <div
          class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div class="relative overflow-hidden bg-cover bg-no-repeat">
            <img src="https://cdn0.fahasa.com/media/catalog/product/8/9/8934974179658.jpg" class="w-full rounded-t-lg" />
            <a href="#!">
          ...
          <div class="p-6">
            <h5 class="mb-4 text-lg font-bold line-clamp-2">{{ product.name }}</h5>
            <p class="mb-4 text-red-500 font-medium dark:text-neutral-300">{{ formatNumber(product.price) }}đ</p>
